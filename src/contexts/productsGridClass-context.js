...
const ProductsGridClassProvider = ({ children }) => {
    ...
    const getTheProductsGridClass = (productsGridClass) => {
        productsGridClass === "ap_all-products normal-grid"? setProductsGridClass("ap_all-products stacked-grid") : setProductsGridClass("ap_all-products normal-grid");
    }

    return <productsGridClassContext.Provider value={{ productsGridClass, setProductsGridClass, getTheProductsGridClass }}>
        { children }
